...
extension UIView {
    ...
    func centerY(inView view: UIView, leadingAnchor: NSLayoutXAxisAnchor? = nil,
                 leadingPadding: CGFloat = 0, constant: CGFloat = 0) {
        
        translatesAutoresizingMaskIntoConstraints = false
        centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: constant).isActive = true
        
        if let leading = leadingAnchor {
            anchor(leading: leading , leadingPadding: leadingPadding)
        }
    }
    ...
    func fillSuperviewToSafearea() {
        translatesAutoresizingMaskIntoConstraints = false
        guard let view = superview else { return }
        let safeArea = view.safeAreaLayoutGuide
        anchor(top: safeArea.topAnchor, leading: safeArea.leadingAnchor,
               bottom: safeArea.bottomAnchor, trailing: safeArea.trailingAnchor)
    }
